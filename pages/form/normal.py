    ...
    st.markdown(f"""
        ...
        ">
            <p style="
                ...
                margin: 0;
            ">
                구독의 시대, 어떻게 하면 더 현명하게 '디지털 월세'를 관리할 수 있을지 생생한 목소리를 듣고 싶습니다.<br>
                보내주신 소중한 응답은 '똑똑한 구독 서비스 관리 앱'을 설계하는 데 핵심적인 데이터로 사용됩니다. 감사합니다!<br>
                <br>
                * 설문 제출 후 DA report / Dashboard로 이동하시면 집계된 데이터를 확인하실 수 있습니다.
            </p>
        </div>

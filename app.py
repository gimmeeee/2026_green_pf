...
# =================================================================
# [CATEGORY 2] 챗봇 비즈니스 로직 (Event Handlers)
# =================================================================
...
def render_visual_dashboard(df):
    ...
    st.markdown("""
        <style>
        [data-testid="column"] { width: fit-content !important; min-width: fit-content !important; flex: unset !important; }
...
def render_chatbot_ui():
    ...
    st.markdown(f"""
        ...
        /* 5. 입력창 내부 레이어: 불필요한 Streamlit 배경 제거 및 오버플로우 허용 */
        ...
        /* 6 입력창 클릭 시 문구(placeholder)가 즉각 반응하도록 설정 */
        div[data-testid="stTextInput"] input:focus::placeholder {{
            color: transparent !important;
        }}
        
        /* 7. 메시지 영역이 입력창과 겹치지 않게 하단 여백 추가 */
        ...
        /* 10. 메시지 영역 하단 패딩 확보: 입력창에 가려지지 않게 함 */
        ...
        /* 11. 클릭(포커스) 시 스타일 유지 및 placeholder 처리 */
